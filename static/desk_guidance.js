...
(() => {
  ...
  document.addEventListener('click',e=>{
    const link=e.target.closest('[data-guide-jump]');if(!link)return;e.preventDefault();jump(link.dataset.guideJump);
